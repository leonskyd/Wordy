...
import com.example.myspaceapp.BuildConfig
...
class PODViewModel (
    ...
    MutableLiveData<PictureOfTheDayData> =
    MutableLiveData(), private val retrofitImpl: PODRetrofitImpl =
    PODRetrofitImpl()) : ViewModel() {
